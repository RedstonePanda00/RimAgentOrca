...
namespace DeepseekTheOrca
{
    ...
    {
        private string BuildPlayerMessage(string playerName, string userText, List<string> contextTags, IEnumerable<string> selectedSkillIds)
        {
        ...
        private string BuildProactiveMessage(OrcaProactiveConversationRequest request, List<string> contextTags)
        {
            StringBuilder builder = new StringBuilder();
            if (OrcaMoodPlugin.Enabled)
            {
        ...
        private static List<string> PlayerContextTags(string userText)
        {
            return new List<string> { "player_chat" };
        }

        private static List<string> ProactiveContextTags(OrcaProactiveConversationRequest request)
        {
