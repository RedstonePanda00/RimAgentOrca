...
namespace DeepseekTheOrca
{
    ...
    public static class GeminiHissService
    {
        ...
        public static GeminiHissState State { get { return Component == null ? null : Component.geminiHiss; } }
        ...
        public static void ResetPersonaState()
        {
            ...
            if (Component != null) Component.geminiHiss = new GeminiHissState();
        }
        ...
        public static AiToolResult Begin(Map map, string reason)
        {
            ...
            var state = new GeminiHissState
            {
                ...
                parameters = DeepseekTheOrcaMod.Settings.geminiHissSettings.Snapshot()
            };
            Component.geminiHiss = state;
        ...
        private static void PollPlanning(GeminiHissState state)
        {
            ...
            if (state.planner == null) state.planner = new LlmIncidentDecisionProvider(state.parameters, state.reason);
